...
public class EnemySpawnController
{
    ...
    public EnemySpawnController(List<AsteroidData> asteroids, ShipData shipData)
    {
    ...
    public void SpawnAsteroid()
    {
        if (Time.time > _nextSpawnTime)
        {
            ...
            _asteroidController = new AsteroidController(_asteroids[asteroidIndex]);
    ...
    {
        _shipController = new ShipController(_shipData);
